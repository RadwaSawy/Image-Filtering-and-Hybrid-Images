...
from helpers import load_image, save_image, my_imfilter, load_image_gray
...
'''
## for gray images
test_image= load_image_gray('../data/cat.bmp')
test_image = rescale(test_image,0.7)
...
identity_image = my_imfilter(test_image, identity_filter, pad='reflect',conv='fft')
